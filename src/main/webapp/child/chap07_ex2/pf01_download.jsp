...
<div class="container mt-5">
    ...
    <table class="table table-striped">
        ...
        <tr>
            <td>64 Corvair</td>
            <td><a href="/musicStore/sound/${product.code}/corvair.mp3" class="btn btn-primary">MP3</a></td>
        </tr>
        <tr>
            <td>Whiskey Before Breakfast</td>
            <td><a href="/musicStore/sound/${product.code}/whiskey.mp3" class="btn btn-primary">MP3</a></td>
        </tr>
        </tbody>
    </table>
