package me.sjihh.hihonweb.chap.nine.one.download;
...
@WebServlet("/download91")
public class DownloadServlet extends HttpServlet {

    private static final String DEFAULT_URL = "/c9e1";
    private static final String REGISTER_URL = "/child/chap09_ex1/register.jsp";
    private static final String DELETE_COOKIES_URL = "/child/chap09_ex1/delete_cookies.jsp";
    ...
    private String determineUrl(String action, HttpServletRequest request, HttpServletResponse response) {
        switch (action) {
            ...
            case "viewCookies":
                return "/child/chap09_ex1/view_cookies.jsp";
            case "deleteCookies":
    ...
    private String checkUser(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (user == null) {
            ...
            if (emailAddress == null || emailAddress.equals("")) {
                ...
                url = "/child/chap09_ex1/" + productCode + "_download.jsp";
            }
        } else {
            url = "/child/chap09_ex1/" + productCode + "_download.jsp";
        }
    ...
    private String registerUser(HttpServletRequest request, HttpServletResponse response) {
        ...
        ServletContext sc = getServletContext();
        String path = sc.getRealPath("/child/chap09_ex1/WEB-INF/EmailList.txt");
